...
<template>
  ...
  <!--只读模式-->
  <div v-if="readOnly">
    <img v-if="!border" :src="value" alt="" :style="{width: `${customSize ? customSize.width : size}px`, height: `${customSize ? customSize.height : size}px`, borderRadius: border ? '50%' : '4px'}">
    <Avatar
      v-else-if="value"
      :size="size"
      :src="value"
  ...
  <!--可编辑-->
  <div v-else class="g-upload-img" :style="{width: `${customSize ? customSize.width : size}px`, height: `${customSize ? customSize.height : size}px`, borderRadius: border ? '50%' : '4px'}">

    <a-spin v-if="uploadLoad" class="uploader-loading" />
    ...
    >
      ...
      <div v-if="!uploadLoad" class="upload-model">
        <GIcon icon="icon-xiangji"></GIcon>
      </div>
      <img v-if="!border && value" class="g-upload-square" :src="value" alt="" :style="{width: `${customSize ? customSize.width : size}px`, height: `${customSize ? customSize.height : size}px` }">
